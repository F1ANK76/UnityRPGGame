...
public class SlotToolTip : MonoBehaviour
{
    ...
    public void ShowToolTip(Item _item, Vector3 _pos)
    {
        ...
        if (_item.itemType == Item.ItemType.Equipment) txt_ItemHowtoUsed.text = "우클릭 - 장착";
        else if (_item.itemType == Item.ItemType.Used) txt_ItemHowtoUsed.text = "우클릭 - 사용";
        else txt_ItemHowtoUsed.text = "";
    }
